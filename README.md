...
## Team Members
- **Mathumita S** - [Your Register Number]
- **Sai Lakshmini R** - [Your Register Number]
...
- **Source Links**:
  - YFP Dataset: [Insert YFP dataset link here]
  - CelebA Dataset: [http://mmlab.ie.cuhk.edu.hk/projects/CelebA.html](http://mmlab.ie.cuhk.edu.hk/projects/CelebA.html)

### Balanced Training Dataset
- **Total Images**: 8,000 records (after balancing)
- **Classes**: 4 severity levels (2,000 images each)
  - Class 0: Normal
  - Class 1: Mild
  - Class 2: Moderate
  - Class 3: Severe
...
- Loads balanced dataset (8K records)
...
2. Run them in order:
   ...
   - Then: `3_predicting_palsy_using_created_dataset.ipynb`
...
%cd facial-palsy-classification
